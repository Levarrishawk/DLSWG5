...
function NabooKaadaraScreenPlay:spawnMobiles()
  ...
  spawnMobile("naboo", "trainer_entertainer", 1, 17.6312, 2.12874, 53.7646, 1, 4105618)
  ...
  spawnMobile("naboo", "trainer_entertainer", 1, -21.662, 2.12878, 75.0346, 166, 4105619)
  ...
  pNpc = spawnMobile("naboo", "trainer_architect",1,5.1,0.6,66.6,119,1741539)
  self:setMoodString(pNpc, "neutral")
