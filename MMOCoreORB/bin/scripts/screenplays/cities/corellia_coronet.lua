...
--  self:setMoodString(pNpc, "neutral")
 ...
 --[[ 
  ...
  spawnMobile("corellia", "stormtrooper", 1, -128.6, 28, -4675.4, -111, 0)
  spawnMobile("corellia", "stormtrooper", 1, -126, 28, -4679.5, -111, 0)
  ...
  spawnMobile("corellia", "stormtrooper", 1, -215.9, 28, -4676.3, 109, 0)
  spawnMobile("corellia", "stormtrooper", 1, -215.9, 28, -4680.3, 90, 0)
  spawnMobile("corellia", "stormtrooper", 1, -215.5, 28, -4683.3, 90, 0)
  ...
  spawnMobile("corellia", "rebel_trooper", 1, -131.6, 28, -4696.8, 51, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -134.5, 28, -4695.0, 51, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -137.6, 28, -4691.8, 51, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -141.3, 28, -4688.1, 51, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -142.7, 28, -4683.4, 51, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -133.5, 28, -4700.3, 51, 0)  
  spawnMobile("corellia", "rebel_trooper", 1, -135.6, 28, -4696.8, 51, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -136.5, 28, -4695.0, 51, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -138.6, 28, -4691.8, 51, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -140.3, 28, -4688.1, 51, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -142.7, 28, -4683.4, 51, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -143.1, 28, -4680.4, 65, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -144.3, 28, -4677.1, 65, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -146.0, 28, -4675.5, 65, 0)
  ...
  spawnMobile("corellia", "rebel_major_general", 1, -143.9, 28, -4694.1, 51, 0)
  spawnMobile("corellia", "fbase_rebel_rifleman_extreme", 1, -148.4, 28, -4684.0, 1, 0)
  
  spawnMobile("corellia", "rebel_trooper", 1, -199.2, 28, -4694.6, -80, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -199.2, 28, -4691.6, -78, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -199.5, 28, -4688.1, -88, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -199.7, 28, -4684.9, -88, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -200, 28, -4682.0, -88, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -200.3, 28, -4678.4, -93, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -291.5, 28, -4674.0, -94, 0)
  spawnMobile("corellia", "rebel_trooper", 1, -199.2, 28, -4672.1, -92, 0)
