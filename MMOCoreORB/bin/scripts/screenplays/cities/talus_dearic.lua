...
function TalusDearicScreenPlay:spawnMobiles()
  ...
  spawnMobile("talus", "trainer_entertainer",1,21.6,2.1,76.0,180,3175572)
  spawnMobile("talus", "trainer_pistol",1,583,6,-2871,10,0)
  spawnMobile("talus", "trainer_medic",1,523,6,-2934,180,0)
  ...
  --Additional Trainers
  spawnMobile("talus", "trainer_combatmedic",1,360.2,6,-2944.1,174,0)
  spawnMobile("talus", "trainer_chef",1,369.6,6,-2944.2,174,0)
  spawnMobile("talus", "trainer_architect",1,320.0,6,-2892.5,112,0)
  spawnMobile("talus", "trainer_1hsword",1,343.5,6,-2928.9,-103,0)
  spawnMobile("talus", "trainer_marksman",1,343.5,6,-2930.9,-103,0)
  spawnMobile("talus", "trainer_commando",1,343.5,6,-2932.9,-103,0)
  spawnMobile("talus", "trainer_pistol",1,343.5,6,-2934.9,-103,0)
  spawnMobile("talus", "trainer_rifleman",1,343.5,6,-2936.9,-103,0)
  spawnMobile("talus", "trainer_medic",1,343.5,6,-2938.9,-103,0)
  spawnMobile("talus", "trainer_squadleader",1,343.5,6,-2940.9,-103,0)
  
  spawnMobile("talus", "trainer_bountyhunter",1,343.5,6,-2917.1,-103,0)
  spawnMobile("talus", "trainer_creaturehandler",1,343.5,6,-2915.1,-103,0)
  spawnMobile("talus", "trainer_smuggler",1,343.5,6,-2913.1,-103,0)
  spawnMobile("talus", "trainer_entertainer",1,343.5,6,-2911.1,-103,0)
  spawnMobile("talus", "trainer_scout",1,343.5,6,-2909.1,-103,0)
  spawnMobile("talus", "trainer_merchant",1,343.5,6,-2907.1,-103,0)
  spawnMobile("talus", "trainer_politician",1,343.5,6,-2905.1,-103,0)
