...
function ChandrilTechScreenPlay:spawnMobiles()
  ...
  self:setMoodString(pNpc, "neutral")
  pNpc = spawnMobile("chandrila", "biogenic_scientist_human",60,-1.8,-12.0,74.1,94,35792132)
  self:setMoodString(pNpc, "neutral")
  ...
  pNpc = spawnMobile("chandrila", "biogenic_scientist_human",60,43.0,-20.0,154.9,-41,35792143)
  self:setMoodString(pNpc, "neutral")
