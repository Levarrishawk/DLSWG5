...
--Entrance/First Hallway
  ...
  --"power room (big blue light place)" area to the right leading to first boss
  ...
  spawnMobile("dungeon2", "tps_black_sun_assassin", 300, 6, -7.0, 0.1, 85, 410000018) 
  spawnMobile("dungeon2", "tps_black_sun_assassin", 300, 13.3, -7.0, 0.0, -93, 410000018)
