...
function ThePowerStationScreenPlay:spawnMobiles()
	...
	spawnMobile("dungeon2", "tps_battle_droid", 300, -21.8, -7.0, -19.1, 97, 410000011)
	spawnMobile("dungeon2", "tps_battle_droid", 300, -21.8, -7.0, -12.1, 97, 410000011)
	spawnMobile("dungeon2", "tps_battle_droid", 300, -21.8, -7.0, -28.1, 97, 410000011)
	spawnMobile("dungeon2", "tps_battle_droid", 300, -21.8, -7.0, -33.6, 97, 410000011)
	spawnMobile("dungeon2", "tps_battle_droid", 300, -21.8, -7.0, -5.1, 97, 410000012)
