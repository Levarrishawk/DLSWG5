...
--  START:  PvP Zone
 ...
 -- Front Lines (npc)
  ...
  spawnMobile("jakku", "at_st_pvp", 120, -5913.8, 30.4, 5851.2, 149, 0)
    
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5913.8, 30.4, 5851.2, 159, 0) 
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5917.1, 30.4, 5849.5, 147, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5909.5, 30.0, 5851.7, 150, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5920.6, 30.4, 5847.6, 145, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5905.5, 29.7, 5852.8, 169, 0)
  
  spawnMobile("jakku", "at_st_pvp", 120, -5969.4, 27.5, 5834.8, 143, 0)
  
  spawnMobile("jakku", "at_st_pvp", 300, -5936.2, 27.6, 5840.1, 164, 0)
  
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5818.4, 40.9, 5853.9, -140, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5823.8, 40.4, 5858.2, -136, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5828.4, 40.1, 5862.4, -135, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5831.8, 40.0, 5866.5, -138, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5837.9, 40.0, 5874.1, -128, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5845.5, 39.6, 5880.7, -142, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5834.8, 39.9, 5870.0, -124, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5813.4, 41.3, 5851.0, -139, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5808.0, 42.2, 5849.7, -138, 0)
  
  spawnMobile("jakku", "at_at_pvp", 300, -5951.6, 34.3, 5572.9, 154, 0)
  
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5946.0, 34.1, 5577.8, 162, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5948.2, 34.2, 5575.5, 162, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5965.1, 33.6, 5571.5, 138, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -5971.1, 34.2, 5569.6, 130, 0)
  
  spawnMobile("jakku", "at_st_pvp", 120, -6063.9, 25.6, 5732.1, 153, 0)
  
  spawnMobile("jakku", "stormtrooper_pvp", 45, -6067.5, 26, 5730.3, 160, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -6068.7, 26.1, 5729.5, 161, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -6058.4, 25.1, 5733.1, 138, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -6055.6, 24.8, 5734.0, 130, 0)
  
  spawnMobile("jakku", "stormtrooper_pvp", 45, -6109.4, 23.6, 5809.6, -169, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -6112.4, 23.8, 5809.7, -169, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -6114.5, 23.9, 5810.1, -169, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -6117.7, 24.0, 5811.3, -169, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -6121.1, 24.1, 5812.5, -169, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -6123.8, 24.3, 5813.5, -169, 0)
  spawnMobile("jakku", "stormtrooper_pvp", 45, -6127.7, 24.7, 5814.8, -169, 0)
  
  spawnMobile("jakku", "at_st_pvp", 120, -6030.9, 36.0, 5906.8, 150, 0)
  
    -- republic lines
    
  spawnMobile("jakku", "at_xt_pvp", 120, -5905, 29.6, 5829.3, -9, 0)
  spawnMobile("jakku", "at_xt_pvp", 120, -5935, 25.4, 5820.3, -19, 0)
  spawnMobile("jakku", "at_xt_pvp", 120, -5928, 25.5, 5821.3, -38, 0)
    
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -5905, 29.6, 5829.3, -31, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -5908.0, 29.2, 5828.0, -22, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -5902.0, 29.0, 5831.0, -14, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -5899.2, 28.4, 5833.5, -33, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -5912.2, 27.8, 5825.6, -27, 0)
  
  spawnMobile("jakku", "rebel_commando_pvp", 35, -5958.0, 26.6, 5819.1, -27, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -5954.0, 26.3, 5822.1, -27, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -5954.0, 26.2, 5819.6, -13, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -5953.0, 26.5, 5829.6, -13, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -5967.0, 26.0, 5820.6, -23, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -5972.0, 25.6, 5821.2, -13, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -5964.5, 25.8, 5816.8, -37, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -5949.0, 26.0, 5820.9, -38, 0)
  
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -5818.1, 35.4, 5832.0, 36, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -5824.7, 34.6, 5837.0, 36, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -5829.0, 34.5, 5842.0, 44, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -5834.0, 33.8, 5845.0, 41, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -5838.2, 34.0, 5849.7, 44, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -5842.0, 34.5, 5852.0, 44, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -5849.0, 33.1, 5857.7, 44, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -5857.0, 33.2, 5863.9, 44, 0)
  
  spawnMobile("jakku", "at_xt_pvp", 120, -5955, 44.6, 5546.8, -33, 0)
  spawnMobile("jakku", "at_xt_pvp", 120, -5938, 42.2, 5557.3, -25, 0)
  
  spawnMobile("jakku", "rebel_commando_pvp", 35, -5949.1, 43.4, 5552.4, -38, 0)  
  spawnMobile("jakku", "rebel_commando_pvp", 35, -5944.4, 42.9, 5554.9, -15, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -5937.7, 42.3, 5558.1, -27, 0)

  spawnMobile("jakku", "at_xt_pvp", 120, -6056.7, 26.4, 5714.2, -21, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -6050.1, 26.3, 5715.0, -11, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -6052.0, 26.1, 5715.8, -11, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -6062.0, 26.5, 5714.5, -11, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -6064.0, 26.1, 5714.8, -11, 0)
  
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -6132.5, 29.3, 5800.0, 2, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -6129.2, 28.9, 5798.9, 12, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -6125.9, 28.9, 5797.5, 10, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -6123.0, 28.8, 5796.2, 12, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -6120.4, 28.8, 5794.2, 12, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -6117.2, 28.6, 5791.9, 12, 0)
  spawnMobile("jakku", "rebel_trooper_pvp", 45, -6113.5, 28.2, 5790.4, 12, 0)
  
  spawnMobile("jakku", "rebel_commando_pvp", 35, -6031.0, 27.7, 5886.4, -11, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -6029.0, 27.7, 5887.0, -11, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -6027.0, 27.7, 5888.4, -11, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -6025.0, 27.7, 5889.0, -11, 0)
  spawnMobile("jakku", "rebel_commando_pvp", 35, -6023.0, 27.7, 5890.4, -11, 0)
