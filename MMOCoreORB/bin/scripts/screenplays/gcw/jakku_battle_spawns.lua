...
--  START:  PvP Zone
 ...
 -- Front Lines (npc)
  ...
  spawnMobile("jakku", "at_at", 300, -5951.6, 34.3, 5572.9, 154, 0)
  
  spawnMobile("jakku", "stormtrooper", 45, -5946.0, 34.1, 5577.8, 162, 0)
  spawnMobile("jakku", "stormtrooper", 45, -5948.2, 34.2, 5575.5, 162, 0)
  spawnMobile("jakku", "stormtrooper", 45, -5965.1, 33.6, 5571.5, 138, 0)
  spawnMobile("jakku", "stormtrooper", 45, -5971.1, 34.2, 5569.6, 130, 0)
  
  spawnMobile("jakku", "at_st", 120, -6063.9, 25.6, 5732.1, 153, 0)
  
  spawnMobile("jakku", "stormtrooper", 45, -6067.5, 26, 5730.3, 160, 0)
  spawnMobile("jakku", "stormtrooper", 45, -6068.7, 26.1, 5729.5, 161, 0)
  spawnMobile("jakku", "stormtrooper", 45, -6058.4, 25.1, 5733.1, 138, 0)
  spawnMobile("jakku", "stormtrooper", 45, -6055.6, 24.8, 5734.0, 130, 0)
  ...
  spawnMobile("jakku", "rebel_trooper", 45, -6132.5, 29.3, 5800.0, 2, 0)
  spawnMobile("jakku", "rebel_trooper", 45, -6129.2, 28.9, 5798.9, 12, 0)
  spawnMobile("jakku", "rebel_trooper", 45, -6125.9, 28.9, 5797.5, 10, 0)
  spawnMobile("jakku", "rebel_trooper", 45, -6123.0, 28.8, 5796.2, 12, 0)
  spawnMobile("jakku", "rebel_trooper", 45, -6120.4, 28.8, 5794.2, 12, 0)
  spawnMobile("jakku", "rebel_trooper", 45, -6117.2, 28.6, 5791.9, 12, 0)
  spawnMobile("jakku", "rebel_trooper", 45, -6113.5, 28.2, 5790.4, 12, 0)
