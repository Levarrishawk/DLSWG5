...
createTrainerConversationTemplate("trainer_1hsword", "combat_jedi_master", "trainer_1hsword_convotemplate")
createTrainerConversationTemplate("trainer_armorsmith", "trader_munitions_master", "trainer_armorsmith_convotemplate")
createTrainerConversationTemplate("trainer_bountyhunter", "secondary_bountyhunter_master", "trainer_bountyhunter_convotemplate")
createTrainerConversationTemplate("trainer_architect", "trader_structures_master", "trainer_architect_convotemplate")
createTrainerConversationTemplate("trainer_creaturehandler", "secondary_beastmaster_master", "trainer_creaturehandler_convotemplate")
createTrainerConversationTemplate("trainer_entertainer", "secondary_entertainer_master", "trainer_entertainer_convotemplate")
createTrainerConversationTemplate("trainer_marksman", "combat_soldier_master", "trainer_marksman_convotemplate")
createTrainerConversationTemplate("trainer_medic", "combat_medic_master", "trainer_medic_convotemplate")
createTrainerConversationTemplate("trainer_merchant", "secondary_merchant_master", "trainer_merchant_convotemplate")
createTrainerConversationTemplate("trainer_pistol", "combat_shocktrooper_master", "trainer_pistol_convotemplate")
createTrainerConversationTemplate("trainer_politician", "social_politician_master", "trainer_politician_convotemplate")
createTrainerConversationTemplate("trainer_smuggler", "secondary_scoundrel_master", "trainer_smuggler_convotemplate")
createTrainerConversationTemplate("trainer_squadleader", "combat_officer_master", "trainer_squadleader_convotemplate")
createTrainerConversationTemplate("trainer_rifleman", "combat_assassin_master", "trainer_rifleman_convotemplate")
createTrainerConversationTemplate("trainer_scout", "secondary_ranger_master", "trainer_scout_convotemplate")
createTrainerConversationTemplate("trainer_droidengineer", "trader_engineering_master", "trainer_droidengineer_convotemplate")
createTrainerConversationTemplate("trainer_commando", "combat_mando_master", "trainer_commando_convotemplate")
createTrainerConversationTemplate("trainer_chef", "trader_domestics_master", "trainer_chef_convotemplate")
createTrainerConversationTemplate("trainer_combatmedic", "trader_pharmacist_master", "trainer_combatmedic_convotemplate")
